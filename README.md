...
5. Перейдите во вкладку «свойства» и укажите там 4-е обязательных свойства:
    5.1. «От кого» (строка), символьный код: «from»;
    5.2. «Кому» (строка), символьный код: «to»;
    5.3. «Тема письма» (строка), символьный код: «subject»;
    5.4. «Тело письма» (HTML/текст), символьный код: «body»;
